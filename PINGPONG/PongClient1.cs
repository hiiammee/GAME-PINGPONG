...
namespace PINGPONG
{
    public partial class PongClient1 : Form
    {
        public PongClient1()
        {
            InitializeComponent();
        ...
        void Receive()
        {
            try
            {
                while (true)
                {
                    ...
                    racket2Pos = Convert.ToInt32(temp[3]);
        ...
        void Congrats(int sign)
        {
            if (sign == 1)
            {
                ...
                ChucMung2 chucMung2 = new ChucMung2();
                chucMung2 .Show();
            }
            else if (sign == 2)
            {
        ...
        private void PongClient1_Load(object sender, EventArgs e)
        {
        ...
        {            
            Send();
            racket2.Top = racket2Pos;
            if (PlayerDetectedDown == true && racket1.Top < bottomEdge)
            {
                racket1.Top += 30;
            }
            if (PlayerDetectedUp == true && racket1.Top > 0)
            {
                racket1.Top -= 30;
            }
            ball.Top = Y;
        ...
        private void PongClient1_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void PongClient1_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Up)
            {
                client_signal = 0;
